...
$status=1;
$sql="INSERT INTO  tblusers(UserId,FullName,MobileNumber,Email,Password,Status) VALUES(:userid,:fname,:mobileno,:email,:password,:status)";
...
if($lastInsertId)
{
echo '<script>alert("Your Registration successfull and your user id is UID"+"'.$userid.'")</script>';
}
else 
{
