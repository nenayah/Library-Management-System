...
$email=$_SESSION['login'];
  $sql ="SELECT Password FROM tblusers WHERE Email=:email and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update tblusers set Password=:newpassword where Email=:email";
