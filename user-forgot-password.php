...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tblusers WHERE Email=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblstudents set Password=:newpassword where email=:email and MobileNumber=:mobile";
