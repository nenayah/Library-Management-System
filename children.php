...
.post-info h2.post-title{font-size:20px;color:#f5678a;font-family:FontAwesome;font-weight:400;line-height:1.6em;padding:12px,0,0,0; margin:0 0 10px}
...
<div id='main-wrapper'>
	<div class='main section' id='main' name='Main Posts' align="center"><div  data-version='2' id='Blog1'>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tablbooks.BookName,tblcategory.CategoryName,tblauthors.AuthorName,tablbooks.ISBNNumber,tablbooks.BookPrice,tablbooks.id as bookid from  tablbooks join tblcategory on tblcategory.id=tablbooks.CatId join tblauthors on tblauthors.id=tablbooks.AuthorId where tblcategory.id='4' order by tablbooks.id desc";
...
{               ?>                                   
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="bookinfo.php?bookid=<?php echo htmlentities($result->bookid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> More</button> 
                                         </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
