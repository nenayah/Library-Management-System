                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                       ...
                                       <tbody>
<?php $sql ="SELECT freebooks.BookName,tblcategory.CategoryName,tblauthors.AuthorName,freebooks.ISBNNumber,freebooks.id as bookid from  freebooks join tblcategory on tblcategory.id=freebooks.CatId join tblauthors on tblauthors.id=freebooks.AuthorId";
...
<a href="bookinfo.php?more=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Are you sure you want to see this book?');" ><button class="bt btn-primary"><i class="fa fa-pencil-square-o"></i> More</button>											
                                         </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
